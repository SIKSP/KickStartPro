function SeeFunc( strFunctionName ){
	//alert( "Function Name: " + strFunctionName )	
}
function SeeID( strID ){
	//alert( "ID: " + strID )	
}
//==========================================================
	...
	try{
		...
		if( intCurrentSelectLen > 1 ){
			...
			if( sID == "To_ActionList_id" || sID == "To_ValueList_id" ){
				SeeID( sID )
				js_hideActionButtons();
				js_hideElement("Action_Steps_id");
				js_hideElement("Value_Steps_id");
			}
			if( sID == "To_List_id" ){
				SeeID( sID )
				js_hideElementButtons();
				js_hideElement("Edit_Elements_id");
			}
		}
	}catch(e){alert(e)}	
}
